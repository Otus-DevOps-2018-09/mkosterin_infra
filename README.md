...
- установлен vagrant
- написан vagrant файл
- изучена работа провижионеров в vagrant
- установлены molecule, testinfra, изучена работа на примере тестирования роли db
### Самостоятельное задание
- конфигурация vagrant дополнена для корректно работы роли nginx
- написан тест для проверки прослушивания порта 27017 роли db
- playbook для пакера переведены на использование ролей
### Задание со *
- роль DB вынесена в отдельный репозиторий https://github.com/mkosterin/db-mongo-role
- подключени travis-ci для тестирования роли в GCE
- в README.md размещен бейдж со статусом билда
- настроено оповещение в slack чат

## Домашнее задание №10
### Обязательная часть
- на основе имеющихся плейбуков созданы две роли app, db
- имеющееся описание инфраструктуры разделено на два окружения stage и prod, с отдельными inventory и переменными
- создано окружение по умолчанию
...
- с использованием переменных, который притянул с собой terraform-inventory из tfstate настроено динамическое использование внутреннего IP адреса базы данных
### Самостоятельное задание
